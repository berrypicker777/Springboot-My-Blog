...
<div class="container my-3">
    ...
    <ul class="pagination mt-3 d-flex justify-content-center">
        ...
        <li class="page-item ${boardPG.first ? "disabled" : ""}"><a class="page-link"
                                                                    href="/?page=${boardPG.number -1}&keyword=${param.keyword}">Previous</a>
        </li>
        <li class="page-item ${boardPG.last ? "disabled" : ""}"><a class="page-link"
                                                                   href="/?page=${boardPG.number +1}&keyword=${param.keyword}">Next</a>
        </li>
        </li>
    </ul>
</div>
